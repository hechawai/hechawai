...
<img src="https://capsule-render.vercel.app/api?type=rect&color=0:36BCF7,50:8A2BE2,100:FF006E&height=3&section=header" width="100%" />
...
- Markdown 富文本 / localStorage 持久化
- 多会话管理 + React Router 独立路由
...
- Markdown rendering / localStorage persistence
- Multi-session management + React Router per-session routes
...
- markdown-it rendering + code highlight
- EJS reusable Header/Footer
...
- Markdown レンダリング / localStorage 永続化
- マルチセッション管理 + React Router 個別ルート
...
- gray-matter で front-matter 解析
- markdown-it レンダリング + コードハイライト
- EJS で Header/Footer 再利用
- ページネーション + 詳細 + タグページ
- sitemap.xml / KaTeX / search.json
...
<img src="https://github-readme-activity-graph.vercel.app/graph?username=hechawai&theme=tokyo-night&hide_border=true&bg_color=0D1117&color=36BCF7&line=8A2BE2&point=FF006E&area=true&area_color=36BCF7" width="100%" />

<br/>

<img src="https://github-profile-trophy.vercel.app/?username=hechawai&theme=tokyonight&no-frame=true&no-bg=true&row=1&column=6&margin-w=10" />
...
<img src="https://capsule-render.vercel.app/api?type=rect&color=0:FF006E,50:8A2BE2,100:36BCF7&height=3&section=header" width="100%" />
